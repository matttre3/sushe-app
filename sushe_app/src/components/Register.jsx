    ...
    function setName(e) {
      ...
      return (
        <>
          ...
          <img className="-mt-[300px] absolute min-w-[700px] md:min-w-[1000px] md:-mt-[700px] spin-image" src={blob} alt="" />
          ...
          <h2 className='mt-[60px] font-medium text-xl color-sushe-dg mb-4'>Registrati ora!</h2>

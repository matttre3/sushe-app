  ...
  return (
    <>
      <div className='relative flex flex-col items-center overflow-hidden'>
        ...
        <div className='mt-20'>
        <button className='font-bold text-l color-sushe-dg bg-sushe-lg rounded-xl p-2 mt-10 w-72'>CREA UN TAVOLO</button>
        ...
        <button className='font-bold text-l color-sushe-dg bg-sushe-lg rounded-xl p-2 mt-5 w-72'>ENTRA IN UN TAVOLO</button>
        </div>
      </div>
    </>
  )
